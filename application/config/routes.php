...
$route['kategori/hapus/(:num)'] = 'kategori/delete/$1';

// Barang
$route['barang'] = 'barang/index';
$route['barang/tambah'] = 'barang/create';
$route['barang/edit/(:num)'] = 'barang/edit/$1';
$route['barang/hapus/(:num)'] = 'barang/delete/$1';

// Peminjaman
$route['peminjaman'] = 'peminjaman/index';
$route['peminjaman/tambah'] = 'peminjaman/create';
$route['peminjaman/kembalikan/(:num)'] = 'peminjaman/return/$1';
